...
function _maintainReassertAction(a, actionObj) {
  if (!((a?.maintain_state === true) || (a?.maintain_state === undefined && String(a?.clear_mode || 'none') === 'source_clears')) || !_actionSupportsMaintain(actionObj)) return null;
